    ...
    <div className="py-16 px-6 md:px-12 bg-[#F8F8F8]">
      <div className="text-center mb-12">
        ...
        <p className="text-lg text-[#151583]">
          Coaching transformations that speak for themselves
        </p>
      </div>
      <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-6">
        {caseStudies.map((item, index) => (
          <div
            key={index}
            className={`rounded-2xl text-white p-6 flex flex-col justify-between min-h-[300px] bg-gradient-to-b ${item.color}`}
          >
            <div>
