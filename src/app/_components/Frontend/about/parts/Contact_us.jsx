...
const Contact_us = ({
  ...
  return (
    <>
      <div
        className="md:mx-5 p-10 md:p-16 md:flex hidden flex-col items-center justify-between md:mt-12 bg-cover bg-center relative  mt-5"
        style={{
          backgroundImage: `url(${bg_image?.src})`,
          backgroundColor: "#151583",
        }}
      >
        ...
        <div className="text-white items-center flex flex-col space-y-8 z-20">
          ...
          <div className="items-center flex flex-col space-y-6 leading-12">
            ...
            <p className="text-lg md:text-xl leading-none text-center">
              {line2}
            </p>
          </div>
          <AnimatedButton name={button_Name ? button_Name : "Contact Us"} />
      ...
      <div
        className="md:mx-5 p-10 md:p-16 flex md:hidden flex-col items-center justify-between md:mt-12 bg-cover bg-center relative  mt-5"
        style={{
          backgroundImage: `url(${mob_bg_image?.src})`,
          backgroundColor: "#151583",
        }}
      >
        <div className="absolute inset-0 bg-black opacity-30 z-10"></div>
