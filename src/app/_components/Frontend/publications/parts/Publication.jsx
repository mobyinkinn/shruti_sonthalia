...
//             <p className="text-[#000000] text-lg md:text-xl max-w-4xl leading-relaxed">
  ...
  return (
    <>
      {publicationData.map((publication) => (
        <section
          key={publication.id}
          className="flex flex-col md:flex-row items-center gap-6 md:gap-8 xl:gap-12 mt-12 px-4 sm:px-8 lg:px-12"
        >
          {/* Image Section */}
          <div className="relative overflow-hidden w-full md:w-[40%]">
            <Image
              src={publication.img}
              ...
              className="w-full h-auto object-cover"
            />
            <button className="absolute bottom-[20px] left-1/2 transform -translate-x-1/2 z-50 flex items-center gap-2 text-[1rem] px-4 py-2 bg-[#E53935] text-white rounded-[10px] hover:bg-white hover:text-[#E53935] hover:border hover:border-[#E53935] transition cursor-pointer">
              <a
                href={publication.link}
                className="text-[white] hover:text-[black]"
              >
          ...
          {/* Text Section */}
          <div className="flex-1 space-y-4 xl:mt-6">
            <h2 className="text-[1.5rem] sm:text-[2rem] font-medium text-[#000000] underline-offset-4">
              {publication.title}
            </h2>

            <p className="text-[#000000] text-lg md:text-xl max-w-full md:max-w-4xl leading-relaxed">
              {publication.shortDescription}
              <a
                href={publication.link}
                className="text-[#151583] hover:text-[#151583] "
